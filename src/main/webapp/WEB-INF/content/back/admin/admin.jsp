...
<head>
    ...
    <!--[if lte IE 8]><link rel="stylesheet" href="${pageContext.request.contextPath}/common/bootstrap/master/responsive-nav.css"><![endif]-->
    <!--[if gt IE 8]><!--><link rel="stylesheet" href="${pageContext.request.contextPath}/common/bootstrap/master/demos/advanced-left-navigation/styles.css"><!--<![endif]-->
    <script src="${pageContext.request.contextPath}/common/bootstrap/master/responsive-nav.js"></script>
</head>
<body>
