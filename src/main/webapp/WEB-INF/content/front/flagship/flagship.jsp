...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12" style="font-size: 15pt;padding-left: 4%;margin-bottom: 20px;">
            <a href="javascript:void(0)"><span class="label label-primary">黑马营</span></a><a href="javascript:void(0)"><span class="label label-primary">精英训练营</span></a>
        </div>
    </div>
