    ...
    <body>
        <div class="container">
                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img width="1140px" height="430px" style="height: 415px;" src="${pageContext.request.contextPath}/common/research/front/index/img/book.jpg" alt="...">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-6"><h2>官方新闻</h2></div>
                        <div class="col-md-6"><h2>专题文章</h2></div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <h3>Heading</h3>
                    ...
                    <div class="row">
                        <div class="col-md-6"><a href="javascript:void(0)">更多...</a></div>
                        <div class="col-md-6"><a href="javascript:void(0)">更多...</a></div>
                    </div>
                    <div class="row">
                        <div class="col-md-6"><h2>博客</h2></div>
                        <div class="col-md-6"><h2>视频</h2></div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <h3>Heading</h3>
                ...
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-12"><h2>最新文章</h2></div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <h3>Heading</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12"><button type="button" class="btn btn-warning form-control" style="height: 50px;">最新发布</button></div>
                    </div>
                    <div class="row" style="margin-top: 30px;">
                        <div class="col-md-12"><button type="button" class="btn btn-warning form-control" style="height: 50px;">招贤纳士</button></div>
                    </div>
                </div>
            </div>
