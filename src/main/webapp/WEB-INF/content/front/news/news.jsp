...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-4"><h2>媒体报道</h2></div>
                <div class="col-md-4"><h2>署名文章</h2></div>
                <div class="col-md-4"><h2>新闻稿</h2></div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <h3>Heading</h3>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="col-md-6"><h2>精彩视频</h2></div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <h3>Heading</h3>
        ...
        <div class="col-md-4">
            <div class="row">
                <div class="col-md-12"><h2>出版物</h2></div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <h3>Heading</h3>
                ...
                <div class="col-md-12"><a href="javascript:void(0)">更多...</a></div>
            </div>
